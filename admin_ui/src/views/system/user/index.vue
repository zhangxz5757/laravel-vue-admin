  ...
  <div class="divBox">
    ...
    <el-card class="mt10">
      ...
      <el-table :data="tableData" highlight-current-row header-cell-class-name="table-header">
        ...
        <el-table-column prop="dept_title" label="所属部门"/>
        ...
        <el-table-column label="操作" min-width="100" fixed="right">
          <template v-slot="scope">
            ...
            <el-button type="text" size="small" style="color: #F56C6C" @click="delRow(scope.row.id)" v-if="scope.row.is_super != 1">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import { getSysUserIndex,storeSysUser, deleteSysUser, sysUserInfo } from '@/api/system/user'
import { deepClone } from '@/utils'
import AddForm from "./components/AddForm.vue";
import { TimeFormat } from "@/utils/common";
import { UserStatusList } from "./options";
export default {
  name: 'SysUser',
  components: {
    AddForm,
